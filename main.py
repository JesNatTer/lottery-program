...
def age_verfication(age):
    try: # error trapping
        if age >= 18:
           return messagebox.showinfo("Success", "Welcome To The Lotto Program")
           root.destroy()
           import lotto
        else:
...
# button
confirm_btn = Button(root, borderwidth="10", text="Verify Age", font="Consolas 15 bold", fg="white", bg="black", command=age_verfication)
